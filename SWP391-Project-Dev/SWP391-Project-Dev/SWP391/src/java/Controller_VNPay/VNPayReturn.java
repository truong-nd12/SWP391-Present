    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (signValue.equals(vnp_SecureHash)) {
            if ("00".equals(request.getParameter("vnp_TransactionStatus"))) {
                ...
                for (Order_Detail or : order.getOrderDetailByCusId(Integer.parseInt(request.getParameter("vnp_TxnRef")))) {
                    order.updateAddProduct(or.getQuantity(), or.getProduct_id());
                }
                order.deleteShip(Integer.parseInt(request.getParameter("vnp_TxnRef")));
